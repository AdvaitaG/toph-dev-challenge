...
export function Dashboard({ data }: { data: DashboardData }) {
  ...
  return (
    <div className="app-shell">
      ...
      <Sidebar activePage="dashboard" farmName={data.farm.name} pendingApprovals={data.pendingApprovals} onInfo={showDemoInfo} onLogout={logout} loggingOut={loggingOut} guest={guest} onUnavailable={(label) => setNotice({ title: label, text: `${label} is not available in this dashboard preview. You can explore employee logs from the Dashboard.` })} />
